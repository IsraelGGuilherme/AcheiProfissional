...
<?= $this->section('title') ?>Cadastro de Usuário Comum - Achei Profissional<?= $this->endSection() ?>
            ...
            <div class="register-card">
                ...
                <div class="text-center mb-4">
                    ...
                    <p class="welcome-text">
                        Informe seu e-mail e crie uma senha de acesso.
                    </p>
                ...
                <form action="<?= base_url('register') ?>" method="POST" id="formRegisterUsuario" novalidate>
                    <!-- <= csrf_field() ?> -->
...
<?= $this->section('scripts') ?>
    <script>
        const form = document.getElementById('formRegisterUsuario');
